...
const lowercaseString = loremString.toLowerCase();

// Split the string into an array of words
const words = lowercaseString.split(" ");

// Set a counter variable to keep track of the number of occurrences of the word "et"
let count = 0;

// Loop through each word in the array and check if it matches the word "et"
...
// Output the result
console.log(`The number of the word 'is' is: ${count}`);
...
if (stringReversed === stringWithoutSpaces) {
  console.log(`String is a palindrome: ${phraseToCheck}`);
} else {
  console.log(`String is not a palindrome: ${phraseToCheck}`);
}